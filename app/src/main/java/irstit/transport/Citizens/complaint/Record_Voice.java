...
public class Record_Voice extends AppCompatActivity {
    ...
    MediaRecorder myAudioRecorder;
     ...
     public  String outputFile = Environment.getExternalStorageDirectory().getAbsolutePath() + "/recording.3gp";
        ...
        recordVoice_Send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //    Tools.getInstance(getApplicationContext()).write("voice", outputFile);
                    ...
                    editor.putString("voice_",outputFile);
                   // editor.commit();
                    editor.apply();
...
//
//                    Intent intentForSend = new Intent(getBaseContext(),Complaint.class);
//                    intentForSend.putExtra("Audio_source_address",outputFile);
